...
//Storing all Pokemon in an empty array
let allPokemons = [];
...
//async function to make sure all the relevant data is obtained first
...
function displayPokemons(pokemon) {
    //Empty list to ensure no overlap 
    listWrapper.innerHTML = "";


    //HTML structure to target each pokemon using IDs
